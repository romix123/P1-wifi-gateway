...
#define MAIN_GRAPHS "<form action='/Grafieken' method='GET'><button type='submit'>Grafieken</button></form>"
...
#define MAIN_UPDATE "<form action='/Update' method='GET'><button type='submit'>Update firmware</button></fieldset></form>"
...
#ifdef FRENCH
#define HELP "/Help' target='_blank'>Aider</a>"
#define TIMESTAMP "%d jours %d heures %d minutes"
#define LAST_SAMPLE " dernier sample: "
#define FIRMWARE_REV " firmware versie: "
...
#define MAIN_GRAPHS "<form action='/Grafieken' method='GET'><button type='submit'>Grafik</button></form>"
